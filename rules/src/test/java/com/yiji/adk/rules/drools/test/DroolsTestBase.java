...
import com.yiji.adk.api.enums.Symbol;
import com.yiji.adk.api.order.*;
import com.yiji.adk.rules.drools.*;
import com.yiji.adk.rules.drools.module.*;
...
//				"java.util.Map");
	...
	protected ArrayList<ConditionOrder> builderConditions() {
		...
		condition.setTypeSimpleName("com.yiji.adk.rules.drools.test.Order");
		condition.setVariableName("order");

		condition2.setCompareValue("\"ligen\"");
		condition2.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \"ligen\";}  }");
	...
	protected ModuleView newModuleView() {
        ...
        //条件赋值
        objectCondition.setTypeSimpleName("com.yiji.adk.rules.drools.test.Order");
        ...
        evalCondition.setConditionScript("package com.yiji;  Calcu extends ExecutorWrapper{  public Object execute(Object ... parameter){return \"jixianenv\" ;}  }");
        evalCondition.setExecutorName("compilerExecutor");
        evalCondition.setRequestName("$order");
        evalCondition.setSymbol(com.yiji.adk.rules.drools.module.Symbol.EQUAL);
	...
	protected InternalRuleEvent newStandardRuleEvent(String eventName, String description,
		...
		rule1Order.setImports(Lists.newArrayList("com.yiji.adk.rules.drools.test.Order", "java.util.ArrayList"));
		...
		rule2Order.setImports(Lists.newArrayList("com.yiji.adk.rules.drools.test.Order", "java.util.ArrayList"));
		...
		evalCondition.setCompareValue("\"jixianenv\"");
		evalCondition
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \"jixianenv\" ;}  }");
		evalCondition.setExecutorName("compilerExecutor");
		evalCondition.setRequestName("$order");
	...
	protected InternalRuleEvent newBaiscTypeInernalRuleEvent(String eventName, String description,
		...
		intOrder
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 9 ;}  }");
		...
		int2Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 8 ;}  }");
		...
		int3Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 7 ;}  }");
	...
	protected InternalRuleEvent newBaiscTypeLongRuleEvent(String eventName, String description,
		...
		intOrder
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 9L ;}  }");
		intOrder.setExecutorName("compilerExecutor");
		intOrder.setRequestName("$order");
		intOrder.setSymbol(Symbol.GREATER_THEN);
		//long >=
		...
		int2Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 8L ;}  }");
		int2Order.setExecutorName("compilerExecutor");
		int2Order.setRequestName("$order");
		int2Order.setSymbol(Symbol.GREATER_EQUAL);
		//long <
		...
		int3Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 7L ;}  }");
		int3Order.setExecutorName("compilerExecutor");
		int3Order.setRequestName("$order");
		int3Order.setSymbol(Symbol.LESS_THEN);
		//long ==
	...
	protected InternalRuleEvent newBaiscTypeFloatRuleEvent(String eventName, String description,
		...
		intOrder
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 9F ;}  }");
		intOrder.setExecutorName("compilerExecutor");
		intOrder.setRequestName("$order");
		intOrder.setSymbol(Symbol.GREATER_THEN);
		//float >=
		...
		int2Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 8F ;}  }");
		int2Order.setExecutorName("compilerExecutor");
		int2Order.setRequestName("$order");
		int2Order.setSymbol(Symbol.GREATER_EQUAL);
		//float <
		...
		int3Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 7F ;}  }");
		int3Order.setExecutorName("compilerExecutor");
		int3Order.setRequestName("$order");
		int3Order.setSymbol(Symbol.LESS_THEN);
		//float ==
	...
	protected InternalRuleEvent newBaiscTypeDoubleRuleEvent(String eventName, String description,
		...
		intOrder
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 9D ;}  }");
		intOrder.setExecutorName("compilerExecutor");
		intOrder.setRequestName("$order");
		intOrder.setSymbol(Symbol.GREATER_THEN);
		//double >=
		...
		int2Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 8D ;}  }");
		int2Order.setExecutorName("compilerExecutor");
		int2Order.setRequestName("$order");
		int2Order.setSymbol(Symbol.GREATER_EQUAL);
		//double <
		...
		int3Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return 7D ;}  }");
		int3Order.setExecutorName("compilerExecutor");
		int3Order.setRequestName("$order");
		int3Order.setSymbol(Symbol.LESS_THEN);
		//double ==
	...
	protected InternalRuleEvent newBaiscTypeCharRuleEvent(String eventName, String description,
		...
		intOrder
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \'E\' ;}  }");
		intOrder.setExecutorName("compilerExecutor");
		intOrder.setRequestName("$order");
		intOrder.setSymbol(Symbol.GREATER_THEN);
		//char >=
		...
		int2Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \'D\' ;}  }");
		int2Order.setExecutorName("compilerExecutor");
		int2Order.setRequestName("$order");
		int2Order.setSymbol(Symbol.GREATER_EQUAL);
		//char <
		...
		int3Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \'C\' ;}  }");
		int3Order.setExecutorName("compilerExecutor");
		int3Order.setRequestName("$order");
		int3Order.setSymbol(Symbol.LESS_THEN);
		//char ==
		...
		int5Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \'B\' ;}  }");
		int5Order.setExecutorName("compilerExecutor");
		int5Order.setRequestName("$order");
		int5Order.setSymbol(Symbol.LESS_EQUAL);
		//char  ==
	...
	protected InternalRuleEvent newBaiscTypeStringRuleEvent(String eventName, String description,
		...
		int7Order
			.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return \"ligen\";}  }");
		int7Order.setExecutorName("compilerExecutor");
		int7Order.setRequestName("$order");
		int7Order.setSymbol(Symbol.EQUAL);
	...
	protected RulePolicy newAddPolicyFromPolicy(String description) {
		...
		int7Order
				.setConditionScript("package com.yiji; import com.yiji.adk.rules.drools.ExecutorWrapper;  Calcu extends ExecutorWrapper{  public Object execute(Object[] parameter){return true;}  }");
		int7Order.setExecutorName("compilerExecutor");
		int7Order.setRequestName("$order");
		int7Order.setSymbol(Symbol.EQUAL);
