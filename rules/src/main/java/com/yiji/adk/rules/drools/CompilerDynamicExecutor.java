...
import com.yiji.adk.rules.drools.module.EvalCondition;
import com.yiji.adk.rules.drools.module.Symbol;
 ...
 * @version 1.0.0
 *
 * @see com.yiji.adk.rules.drools.DynamicConditionExecutor
 * @see com.yiji.adk.rules.drools.GroovyDynamicExecutor
 */
public class CompilerDynamicExecutor extends DynamicConditionExecutor {
	...
	public static final String PACKAGE_NAME = "package com.yiji.adk.rules.drools.compiler;";
	
	public static final String CLASS_NAME_PRE = "com.yiji.adk.rules.drools.compiler";
	...
	private ExecutorWrapper newInstance(String conditionScript) {
		...
		try {
			...
			ExecutorWrapper wrapper = (ExecutorWrapper) com.yiji.adk.common.compiler.Compiler.getInstance()
