...
package com.yiji.adk.flow.test;

import com.alibaba.dubbo.config.annotation.Reference;
import com.alibaba.dubbo.rpc.RpcContext;
import com.google.common.collect.Maps;
import com.yiji.adk.flow.FlowContext;
import com.yiji.adk.flow.test.fastpay.Consumer;
import com.yiji.adk.flow.test.fastpay.Customer;
...
@SpringApplicationConfiguration(classes = {FastPayYijiBootWithRetryOracleTest.class})
@YijiBootApplication(sysName = "yiji-adk-test", heraEnable = false, httpPort = 0)
@Configuration
public class FastPayYijiBootWithRetryOracleTest {
    ...
    public static void initEnv() {
        ...
        System.setProperty("yiji.adk.flowengine.dialect", "oracle");
        System.setProperty("yiji.ds.url", "jdbc:oracle:thin:@192.168.45.84:1521:testdb");
        System.setProperty("yiji.ds.username", "adk_sdev");
        System.setProperty("yiji.ds.password", "adk_sdev123");
    }
    ...
    public void testRetryProvider() throws InterruptedException {
        ...
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('1', '001', '005v00000c0000000001703151914050001', 'fast_pay_retry_fail_bomb', '1', 'retryValidate', '1', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '3', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('2', '002', '005v00000c0000000001703151914050002', 'fast_pay_retry_fail_bomb', '1', 'retryValidate', '1', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '3', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-14 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('3', '003', '005v00000c0000000001703151914050003', 'fast_pay_retry_fail_bomb', '1', 'xx', '1', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        ...
        clean();
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('1', '001', '005v00000c0000000001703151914050001', 'fast_pay_retry_fail_bomb', '1', 'retryValidate', '2', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('2', '002', '005v00000c0000000001703151914050002', 'fast_pay_retry_fail_bomb', '1', 'retryValidate', '2', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-14 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE_BOMB VALUES ('3', '003', '005v00000c0000000001703151914050003', 'fast_pay_retry_fail_bomb', '1', 'xx', '2', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failBomb', NULL, NULL, NULL, TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        ...
        clean();
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE VALUES ('1', '001', '005v00000c0000000001703151914050001', 'fast_pay_retry_fail_retreat', '1', 'retryValidate', '1', TO_DATE('2010-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failRetreat', 1,'byDouble', 'hour',  TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE VALUES ('2', '002', '005v00000c0000000001703151914050002', 'fast_pay_retry_fail_retreat', '1', 'retryValidate', '1', TO_DATE('2010-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failRetreat',1, 'byDouble','hour', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),TO_DATE( '2017-03-14 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
        jdbcTemplate.execute(
                "INSERT INTO FLOW_TRACE VALUES ('3', '003', '005v00000c0000000001703151914050003', 'fast_pay_retry_fail_retreat', '1', 'xx', '1', TO_DATE('2010-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), 'retryValidate', '2', '', 'BizError', 'failRetreat', 1,'byDouble', 'hour',TO_DATE( '2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),TO_DATE( '2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'), '005v00000c0000000001703151914050000', TO_DATE('2017-03-15 19:14:05','YYYY-MM-DD HH24:MI:SS'),'{\"balance\":0,\"userName\":\"李根\",\"consumer\":{\"node\":\"error\",\"price\":90,\"productName\":\"极限恶女剑\",\"status\":\"FAIL\"}}','{\"orderId\":\"001\"}')");
