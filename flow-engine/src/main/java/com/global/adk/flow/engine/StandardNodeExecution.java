...
public class StandardNodeExecution implements NodeExecution {
    ...
    public void execute() {
        ...
        try {
            ...
            Object result = invokeDelegateContext
                    .invoke(new Object[]{flowKey, nodeName, com.global.adk.flow.annotation.Error.class, execution});
    ...
    private void decision(FlowNode flowNode, Execution execution) {
        if (flowNode instanceof ActivityNode) {
            ...
            com.global.adk.flow.module.Condition condition = activityNode.getCondition();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("com.global.adk.flow.engine.StandardNodeExecution{");
