...
import com.yiji.adk.flow.state.retry.RetryFailTypeEnum;
import com.yiji.adk.flow.state.retry.RetryMeta;
import com.yiji.adk.flow.state.retry.RetryRetreatTimeUnitEnum;
import com.yiji.adk.flow.state.retry.RetryRetreatTypeEnum;
 ...
 * <p/>
 * exit 条件见 {@link com.yiji.adk.flow.module.Transition#exitRetry(Execution)}
 *
